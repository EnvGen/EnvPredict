...
write.table(responses_matrix_target, paste(output_files_path, 'norm_asv_counts_18S_phyt_plan_genus_2015_20177_different_years_Actual.tsv', sep = "/"), sep="\t")
write.table(predicted_responses, paste(output_files_path, 'norm_asv_counts_18S_phyt_plan_genus_2015_20177_different_years_Predictions.tsv', sep = "/"), sep="\t")
